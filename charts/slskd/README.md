...
**Homepage:** <https://github.com/baconing/charts>

## Maintainers

| Name | Email | Url |
| ---- | ------ | --- |
| Baconing | <iam@baconi.ng> | <https://baconi.ng> |
| AlexMorbo | <alex@morbo.ru> |  |

## Source Code

* <https://github.com/baconing/charts/tree/master/charts/slskd>
...
| app.config.soulseek.description | string | `"slskd on Helm!"` |  |
...
| app.config.transfers.download.destination.permissions.mode | string | `"644"` |  |
